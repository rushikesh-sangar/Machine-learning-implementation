# SLR salary prediction streamlit app
...
model = pickle.load(open(r'C:\Users\dell\Data science vs code\Machine learning\Regression algorithm\SLR salary prediction\Linear_regression_model.pkl', 'rb'))

# Set the title of the streamlit app
st.title('Salary prediction app')

# Add brief description
st.write('This app predicts the salary based on years ofexperience using a simple linear regression model')
